Понятно! Давайте сосредоточимся именно на **паттерне проектирования Decorator** (Декоратор) — как он реализуется на уровне классов, а не функций. Вот полный гайд с акцентом на ООП и классическую реализацию паттерна.
